...
Shopify client application client side.
...
```
echo ClientApp/Client/ >> .git/info/sparse-checkout
```
...
You should now have the ClientApp/Client directory. No other Git source files exist in your local copy.
