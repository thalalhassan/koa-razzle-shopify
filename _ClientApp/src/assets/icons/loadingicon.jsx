...
export default function loadingicon() {
  return (
    ...
    <svg xmlns="http://www.w3.org/2000/svg" width="200px" height="200px" viewBox="0 0 100 100" preserveAspectRatio="xMidYMid">
      <circle cx="84" cy="50" r="5.82804" fill="#93dbe9">
        ...
        <animate attributeName="fill" repeatCount="indefinite" dur="1s" calcMode="discrete" keyTimes="0;0.25;0.5;0.75;1" values="#93dbe9;#3b4368;#5e6fa3;#689cc5;#93dbe9" begin="0s" />
      </circle>
      <circle cx="64.1847" cy="50" r="10" fill="#93dbe9">
      ...
      <circle cx="16" cy="50" r="0" fill="#689cc5">
      ...
      <circle cx="16" cy="50" r="4.17196" fill="#5e6fa3">
      ...
      <circle cx="30.1847" cy="50" r="10" fill="#3b4368">
